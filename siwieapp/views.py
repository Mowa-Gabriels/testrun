...
def export(request):
    ...
    writer.writerow(['Org Name', 'Address', 'State', 'Course', 'Tel', 'PayStat'])

    for internship in Internship.objects.all().values_list('name_of_org', 'address', 'state', 'course', 'tel', 'pay_status'):
