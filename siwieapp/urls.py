...
urlpatterns = [
 ...
 path('dashboard/internship/e-logbook/detail/<logbook_id>', views.log_detail, name='log_single'),
 path('dashboard/internship/e-logbook/edit/<logbook_id>', views.Addlog_Edit, name='log_edit'),
 ...
 path('download_listings/.csv_download', views.export, name='export'),
 path('add_listings/.csv_upload', views.import_csv, name='import'),
